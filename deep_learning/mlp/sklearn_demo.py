"""多层感知机 MLP（scikit-learn 版）：使用 iris 并输出准确率。"""
...
def main():
    ...
    # 6. 绘制损失曲线，观察训练过程是否收敛。
    mlp_model = model.named_steps["mlpclassifier"]
    ...
    plt.plot(mlp_model.loss_curve_, color="tab:blue")
